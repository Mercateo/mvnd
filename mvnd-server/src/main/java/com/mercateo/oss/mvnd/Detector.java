...
public abstract class Detector {
    ...
    private static final String[] LINUX_OS_RELEASE_FILES = { "/etc/os-release",
            "/usr/lib/os-release" };
    ...
    protected void detect(Properties props, List<String> classifierWithLikes) {
        ...
        if (!"false".equalsIgnoreCase(failOnUnknownOS)) {
            if (UNKNOWN.equals(detectedName)) {
                throw new IllegalArgumentException("unknown os.name: " + osName);
            }
            if (UNKNOWN.equals(detectedArch)) {
                throw new IllegalArgumentException("unknown os.arch: " + osArch);
            }
        }
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (line.startsWith(LINUX_VERSION_ID_PREFIX)) {
                    // Set the ID for this version.
                    version = normalizeOsReleaseValue(line.substring(LINUX_VERSION_ID_PREFIX
                            .length()));
                    continue;
                }
    ...
    private static LinuxRelease parseLinuxRedhatReleaseFile(File file) {
        ...
        try {
            ...
            if (line != null) {
                ...
                final Set<String> likeSet = new LinkedHashSet<String>(Arrays.asList(
